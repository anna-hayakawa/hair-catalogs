...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="{{ action('Admin\CatalogController@add') }}" role="button" class="btn btn-primary">新規投稿</a>
                </div>
                <div class="col-md-4">
                    <a href="{{ action('Admin\CatalogController@add') }}" role="button" class="btn btn-primary">プロフィール編集</a>
                </div>
                <hr color="#c0c0c0">
